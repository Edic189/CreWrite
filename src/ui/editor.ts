...
const appTheme = EditorView.theme(
  {
    ...
    // Search/replace panel + autocomplete tooltip.
    ...
    ".cm-panel.cm-search": { padding: "10px 14px", fontFamily: "var(--font-ui)" },
    ".cm-textfield": {
      backgroundColor: "var(--bg)",
    ...
    ".cm-button:hover": { backgroundColor: "var(--bg-active)", borderColor: "var(--accent)" },
